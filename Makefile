...
CC=g++
CFLAGS=-I.
DEPS = src/turingmachine/turingmachine.hpp src/evaluator/evaluator.hpp
OFILES = src/turingmachine/turingmachine.o src/turingmachine/tmconfig.o src/turingmachine/tmstate.o src/evaluator/evaluator.o src/evaluator/filereader.o
